...
TextStyle kStyleNote  = kStyleBase.copyWith(color: kColNote,   fontWeight: FontWeight.w700);
...
TextStyle kStyleLabel = kStyleBase.copyWith(color: kColAccent, fontSize: 15, fontWeight: FontWeight.w600);
...
Color columnColor(CellColumn col) {
  switch (col) {
    case CellColumn.note:       return kColNote;
    case CellColumn.instrument: return kColInst;
    case CellColumn.volume:     return kColVol;
    case CellColumn.pan:        return kColPan;
    case CellColumn.fx0cmd:
    case CellColumn.fx1cmd:
    case CellColumn.fx2cmd:     return kColFxCmd;
    case CellColumn.fx0val:
    case CellColumn.fx1val:
    case CellColumn.fx2val:     return kColFxVal;
  }
}
